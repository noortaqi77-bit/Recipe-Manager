...
Users can add recipes, rate them, create shopping lists, track cooking

history, and get recipe recommendations.
...
- *Random Recipes:* Get a random recipe suggestion.

- *Recipe's Rate:* Rate recipes and view them sorted by rating.
...
- *Cooking History:* Update the last cooked date and get suggestions
  ...
  for recipes that have not been cooked for a while.
